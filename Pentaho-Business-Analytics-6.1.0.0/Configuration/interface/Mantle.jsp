...
<head>
  ...
  <script type="text/javascript">
      /*var chequearRenderizado = setInterval(function(){ myTimer() }, 50);

      function myTimer() {
        var u=document.getElementById("home.perspective");
        if (typeof u != 'undefined'){
            var button=u.contentDocument.getElementById("createNewSaikuAnalyticsButton");
            if(button!=null){
              if (typeof button != 'undefined'){
                  button.click();
                  document.getElementById("pucContent").style.display = "block";
                  clearInterval(chequearRenderizado);
              }
            }
        }
      } */
...
<body oncontextmenu="return false;" class="pentaho-page-background">
  ...
  <div ng-show="viewContainer === 'PUC'" 
    ...
    <div id="pucHeader" cellspacing="0" cellpadding="0">
      ...
      <div id="logo" style="float: right; padding-right:10px;"><IMG style=" height: 45px;" src="mantle/logo.png" ></IMG></div>
    </div>

    <div id="pucContent" style="display: block;"></div>
  </div>
