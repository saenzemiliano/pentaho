...
<body data-spy="scroll" data-target=".sidebar" >
  ...
  <ul style="margin: 0px;">
    ...
    <li><a href="javascript:Home.openFile('Saiku Analytics','Saiku Analytics', 'content/saiku-ui/index.html?biplugin5=true');">Saiku Analytics</a></li>
  </ul>

  <div style="margin-left:20%;padding:1px 16px;">
    <h2 style="margin-top: 20px;">Guia rapida</h2>
    <h3>1 - Click en Archivos para abrir el Explorador de Archivos.</h3>
    <h3>2 - Click en Saiku Analytics para crear una nueva consulta OLAP.</h3>
    <h3>3 - Click en para cerrar sesion.</h3>
    

  </div>


<div class="container-fluid main-container" style="display: none">
  <div class="row-fluid">
